 ...
 *
 * -----
 * Based on zF77_-_ANSI-ISO Split Backspace_-_PrintScr.json from Joe of Model F Labs
 */
/* all
 * - Base
 * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┐  ┌───┬───┬───┐
 ...
 * ├───┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴───┤  ├───┼───┼───┤
 * │Tab  │ Q │ W │ E │ R │ T │ Y │ U │ I │ O │ P │ [ │ ] │Bspc │  │Ins│Hom│PGu│
 * ├─────┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬────│  ├───┼───┼───┤
 * │Caps  │ A │ S │ D │ F │ G │ H │ J │ K │ L │ ; │ ' │ # │Ent │  │Del│End│PGd│
 * ├────┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴───┴┬───┤  ├───┼───┼───┤
 * │Lsft│ \ │ Z │ X │ C │ V │ B │ N │ M │ , │ . │ / │ Fn1  │Sft│  │   │Up │   │
 * ├────┴┬──┴┬──┴──┬┴───┴───┴───┴───┴───┴─┬─┴──┬┴───┴┬───┬─┴───┤  ├───┼───┼───┤
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT_all(
	   ...
	   KC_LSFT, KC_NUBS, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, MO(_FN1), KC_RSFT,   _______,   KC_UP,   _______, 
	...
	[_FN1] = LAYOUT_all(
	   ...
	   _______, _______, _______,                  MO(_FN2),            _______, _______, _______, _______,                            _______, _______, _______
        ...
        [_FN2] = LAYOUT_all(
           ...
           _______,   _______, _______, EE_CLR, QK_BOOT, HPT_TOG, _______, _______, _______, _______, _______, _______, _______, _______,              _______, _______, _______,
