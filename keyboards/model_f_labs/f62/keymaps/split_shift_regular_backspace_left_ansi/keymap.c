 ...
 *
 * -----
 * Based on zF62_HHKB_split_right_shift_only,_everything_else_ANSI.json from Joe of Model F Labs
 */
/* all
 * - Base
 * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┐
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_FN1] = LAYOUT_all(
        ...
        [_FN2] = LAYOUT_all(
            ...
            _______,   _______, _______, EE_CLR, QK_BOOT, HPT_TOG, _______, _______, _______, _______, _______, _______, _______, _______,
