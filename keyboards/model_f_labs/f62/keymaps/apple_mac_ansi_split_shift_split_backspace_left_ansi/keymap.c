...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_ansi_split_shift_split_backspace(
       ...
       KC_LCTL, KC_LALT,   KC_LCMD,               KC_SPC,                     KC_RCMD,         KC_RALT, KC_RCTL
    ),
        [_FN1] = LAYOUT_ansi_split_shift_split_backspace(
        ...
        [_FN2] = LAYOUT_ansi_split_shift_split_backspace(
            _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, HF_DWLD,HF_DWLU, _______, _______,
            _______,   _______, _______, EE_CLR, QK_BOOT, HF_TOGG, _______, _______, _______, _______, _______, _______, _______,
